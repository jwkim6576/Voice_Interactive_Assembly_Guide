...
class YoloNode(Node):
    def __init__(self):
        ...
        self.get_logger().info("✅ YOLO Node v7 Ready (All Objects Scan Mode)")
            ...
            for r in results:
                if r.obb is not None:
                    for i, c in enumerate(r.obb.cls):
                        ...
                        # 좌표 계산 (파란선 각도 사용)
                        coords = self.get_camera_coordinates(cx, cy, short_angle)
