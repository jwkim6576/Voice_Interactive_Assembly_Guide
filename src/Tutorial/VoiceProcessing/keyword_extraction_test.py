...
# 방법 1의 import PromptTemplate 부분을 아래 코드로 대체하세요.
...
class CustomChain:
    ...
    def invoke(self, inputs):
        ...
        # ChatOpenAI 객체를 직접 호출하거나 invoke 메서드 사용
...
if __name__ == "__main__":
    ...
    output_message = "못 박을수 있는 공구를 위치1에 넣어줘"
    extract_keyword = ExtractKeyword(use_embedding=False)
